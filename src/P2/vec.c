...
INCLUDE_ASM(const s32, "P2/vec", SetVectorCylind);

INCLUDE_ASM(const s32, "P2/vec", SetVectorSphere);
...
INCLUDE_ASM(const s32, "P2/vec", ConvertDeulToW);

INCLUDE_ASM(const s32, "P2/vec", FCalculateMuzzleVelocity);

INCLUDE_ASM(const s32, "P2/vec", FCalculateMuzzleVelocity1);

INCLUDE_ASM(const s32, "P2/vec", FCalculateMuzzleVelocityAngle);
